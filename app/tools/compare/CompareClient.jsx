...
// Generated videos to pick from: the caller's own by default (same source as
// the studio history rail), or any gallery creator's work via the dropdown —
// the community gallery is browsable by every signed-in user, so the picker
// reuses the same endpoints. Text rows keep this light.
