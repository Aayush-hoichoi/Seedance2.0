...
export async function POST(request, { params }) {
    ...
    const [override] = await sql`INSERT INTO user_model_overrides
        (project_id, user_id, model_id, effect, valid_from, valid_until, created_by, revoked_at)
        VALUES (${project.id}, ${body.userId}, ${body.modelId}, ${body.effect}, ${body.validFrom ?? null}, ${body.validUntil ?? null}, ${user.userId}, NULL)
    ...
    await writeAudit(sql, {
        ...
        after: { projectId: project.id, userId: body.userId, modelId: body.modelId, effect: body.effect, validUntil: body.validUntil ?? null },
