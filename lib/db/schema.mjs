...
export const GATEWAY_DDL = [
    ...
    `CREATE OR REPLACE VIEW gallery_generations AS
        SELECT
            ...
            -- treats those as unconfirmed.
            j.result->>'video_key'                                              AS video_key,
            -- v17→v18: project and style provenance used by dataset exports.
            -- Append-only: CREATE OR REPLACE VIEW requires every existing
            -- column to retain its name and ordinal position.
            j.project_id,
        ...
        SELECT
            ...
            NULL, NULL, NULL, ue.project_id, NULL, NULL::int, NULL::jsonb
    ...
    `CREATE OR REPLACE VIEW dataset_samples AS
        SELECT
            ...
            -- v17→v18 append-only export provenance.
