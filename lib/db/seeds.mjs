...
function catalog() {
    ...
    return [
        ...
        {
            id: 'seedream-5.0-pro', display: 'Seedream 5.0 Pro', category: 'image', isDefault: true, kind: 'seedream_pro',
            provider: 'byteplus',
            providerModelId: env.SEEDREAM_MODEL_ID || 'seedream-5-0-pro',
            caps: {},
            route: { mode: 'interactive', status: 'active' },
        },
        {
            id: 'nano-banana-pro', display: 'Nano Banana Pro', category: 'image', isDefault: true, kind: 'nano_banana_pro',
            provider: 'google',
            providerModelId: env.NANO_BANANA_PRO_MODEL_ID || 'gemini-3-pro-image-preview',
            caps: {},
            // Gemini Batch API: 50% pricing, async. Active — the studio submits
            // image jobs here; they fail with a clear error until GOOGLE_API_KEY is set.
            route: { mode: 'batch', status: 'active', timeoutSeconds: 86400 },
        },
        {
