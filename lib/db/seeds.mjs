...
function catalog() {
    ...
    return [
        ...
        },
        {
            ...
            caps: {},
            // Gemini Batch API: 50% pricing, async; disabled until GOOGLE_API_KEY exists.
            route: { mode: 'batch', status: 'disabled', timeoutSeconds: 86400 },
        },
        {
            id: 'nano-banana-2', display: 'Nano Banana 2', category: 'image', isDefault: false, kind: 'nano_banana_2',
            provider: 'google',
