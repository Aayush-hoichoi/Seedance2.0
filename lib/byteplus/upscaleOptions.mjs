...
// 35–58 min; a 4s Pro 4K 8-bit took 10.5 min) — retune as more jobs finish.
export const UPSCALE_MIN_WAIT_MIN = Object.freeze({ standard: 5, professional: 12, sixteenBit: 35 });
