...
// Every studio group is named by uploadGroupName(), which always starts with
// this. Derived from that function rather than retyped so a rename can't
// silently narrow the sweep to nothing — an empty match would look like a
// clean pool instead of a broken sweep.
const STUDIO_GROUP_PREFIX = uploadGroupName(null);
