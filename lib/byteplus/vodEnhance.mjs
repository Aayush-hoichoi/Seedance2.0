...
export async function submitEnhancement({ videoUrl, requestBody = null }) {
    ...
    delete providerRequestBody._gallery;
    delete providerRequestBody._billing;
    const data = await requestJson(`${baseUrl()}${path}`, {
        method: 'POST', headers: auth, body: JSON.stringify(enhancementBody(videoUrl, {}, providerRequestBody)),
    });
