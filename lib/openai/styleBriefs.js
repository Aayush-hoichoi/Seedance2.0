...
- Additional videos, when attached (Video 2, Video 3): secondary reference only — never a second source of performance, timing or audio.
- Reference images: Image 1 (and Image 2, Image 3, … when attached) — use only as reference for the environment, benches, and clothing.
