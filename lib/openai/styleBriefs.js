...
- Open by naming the medium and the hero subject, then build outward in this order so the model locks the scene: (1) medium + hero subject + what they are doing, (2) setting/environment and key supporting elements with their spatial relationships, (3) composition and framing — shot size, camera angle/height, placement, foreground vs background, (4) lighting — source, direction, quality (hard/soft), time of day and colour temperature, (5) colour palette / grade, (6) the camera-and-lens rendering translated from the settings, (7) overall mood and atmosphere.
...
- Describe lighting physically (e.g. "low warm sun raking from frame-left, long soft shadows, a gentle rim of light along the shoulders"). Believable light is where this model most outperforms others — spend words here.
...
3. Deliver one cohesive, photorealistic still: a single richly detailed but coherent paragraph in which every element serves the scene.
