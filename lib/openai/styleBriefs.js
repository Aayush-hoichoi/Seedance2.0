...
- The mannequin NEVER appears in the output. Its blank white body, featureless face, and studio backdrop must be fully replaced by the character and scene from the reference image(s) / the user's description. Only its movement survives.
...
- Replace the studio backdrop with the scene from the reference image(s) or the user's description.
...
- Do not show the mannequin's studio backdrop.
