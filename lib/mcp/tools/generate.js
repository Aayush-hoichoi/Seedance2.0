    ...
    registerTool(server, {
        ...
        run: async ({ user, args }) => {
            ...
            const result = await createVideoTask({
                user, projectId: args.projectId ?? null, mode: args.mode ?? null,
                styleLook: args.styleLook ?? null, workflowId: args.workflowId ?? null, request,
            });
        ...
        run: async ({ user, args }) => {
            ...
            const result = await enqueueGeneration({
                ...
                options: {
                    ...
                    ...(args.styleLook ? { styleLook: args.styleLook } : {}),
                    ...(args.workflowId ? { styleWorkflowId: args.workflowId } : {}),
                },
            });
