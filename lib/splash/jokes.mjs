...
export const HELLOS = [
    ...
    'The set is dressed and waiting, {name}.',
    'Enter {name}, stage left.',
    'Roll sound. Roll camera. Roll {name}.',
    'We’re rolling, {name} — make it count.',
    'That’s a wrap on waiting. Hello, {name}.',
    'Cut! …Just kidding. Welcome, {name}.',
    'The prompt bar has been lonely, {name}.',
    'Fresh timeline, blank canvas, hello {name}.',
    'Good to see you, {name}. The pixels are ready.',
    'Warming up the render farm for {name}…',
    'Look alive, everyone — {name} is on set.',
    'One more take, {name}? Of course.',
    'The seed is random, but {name} showing up was inevitable.',
    'Standing by for {name}.',
    'Your studio, {name}. Your rules.',
    'Somewhere a GPU just whispered “{name}”.',
    'Back for more, {name}? Excellent.',
    'The clapperboard is loaded, {name}.',
    'Welcome to the good part, {name}.',
    'Hello {name} — let’s make something ridiculous.',
    'The frame is empty. Fix that, {name}.',
    'Big day ahead, {name}. Or at least a colourful one.',
    'The queue heard you coming, {name}.',
    'Director on deck: {name}.',
    'Boot sequence complete. Hello, {name}.',
    'All systems dreaming. Welcome, {name}.',
    'Ready when you are, {name}.',
    'Nice of you to drop by, {name}.',
    'The muse called in sick, but {name} is here.',
    'A wild {name} appears 🎥',
    'Storyboards up, coffee poured. Hi, {name}.',
    'Let the rendering commence, {name}.',
    'Hey {name} — the pixels missed you.',
    'It’s showtime, {name}.',
    'Two minutes to first frame, {name}.',
    'The studio lights just found you, {name}.',
    'Welcome home, {name}.',
    'Something great is about to render, {name}.',
    'Grab a seat, {name}. The show is yours.',
    'The timeline is blank and full of promise, {name}.',
    'Whatever you’re imagining, {name} — let’s go.',
    'Fade in: {name}.',
    'Hold for {name}… and, action.',
    'The best ideas arrive unannounced. Hi, {name}.',
    'Reporting for duty, {name}? Good.',
    'Another day, another masterpiece attempt. Hello, {name}.',
    'The render farm is spun up and slightly nervous, {name}.',
    'Curtain up, {name}.',
    'You again, {name}? Thank goodness.',
    'Take your mark, {name}.',
];
