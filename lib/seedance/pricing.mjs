...
const RATES = {
    ...
    fast: { sd: [5.6, 3.3] },
    mini: { sd: [3.5, 2.1] },
    // ponytail: Seedance 1.5 Pro rates approximated from 2.0 Pro (`full`) — the
    // ModelArk pricing page is a SPA (couldn't scrape). Conservative (1.5 ≤ 2.0);
    // replace with the real 1.5-pro rates when confirmed. No 4k tier (not supported).
    pro_1_5: { sd: [7.0, 4.3], '1080p': [7.7, 4.7] },
};
...
const EXAMPLE_5S = {
    ...
    pro_1_5: { '480p': 0.35, '720p': 0.76, '1080p': 1.87 }, // approximated from full (see RATES)
};
