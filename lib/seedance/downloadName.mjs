...
export function safeName(name, url, fallback) {
    ...
    // Callers sometimes deliberately choose the output type (for example an
    // EXR download or a QuickTime-compatible MOV). Do not append the source
    // URL's extension over that explicit choice.
