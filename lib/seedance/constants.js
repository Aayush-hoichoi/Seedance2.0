...
// Gemini image config (generationConfig.imageConfig). Aspect ratio works on
// both Nano Banana models; resolution (imageSize) is a Gemini-3 / Nano Banana
// Pro feature — gemini-2.5-flash-image (Banana 2) is fixed ~1MP, so the
// resolution pill is only offered for models that declare `resolutions`.
...
// `resolutions`: the imageSize tiers this model accepts (absent = fixed size).
export const IMAGE_MODELS = [
    { id: 'nano-banana-2', name: 'Nano Banana 2', kind: 'nano_banana_2' },
