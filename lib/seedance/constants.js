...
export const MODELS = [
    ...
    // 2.5 stays out of the picker until its catalog row is activated — the studio
    // filters this list by the active catalog's kinds (SeedanceStudio) — so it is
    // safe to carry here while it waits on BytePlus.
    { id: MODEL_25_ID, name: 'Seedance 2.5', kind: 'full_2_5', gated: true, supports1080p: true, supports4k: true, supportsReference: true },
