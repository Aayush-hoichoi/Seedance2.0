...
export const MODELS = [
    ...
    // 2.5 caps at 720p — VERIFIED against the live API on 2026-08-13 by submitting
    // one task per tier, not assumed from the 2.0 family:
    //   480p/720p accepted · 1080p "not supported for this account and model"
    //   · 4k "not valid for model dreamina-seedance-2-5 in t2v"
    // These shipped as true-by-analogy and users hit the 1080p rejection at submit
    // time, after the request had already been priced and estimated — every check
    // in this app agreed 1080p was fine because this list said so.
    // The 1080p refusal is ACCOUNT-scoped, so a BytePlus plan/resource-pack change
    // may unlock it; re-probe before flipping it back. 4k is a model limit.
    { id: MODEL_25_ID, name: 'Seedance 2.5', kind: 'full_2_5', gated: true, supports1080p: false, supports4k: false, supportsReference: true },
