...
export const MODES = [
    ...
    },
    {
        ...
        hint: 'Upload a GREEN-SCREEN performance video — the studio converts it into its silent white-mannequin motion twin on a pure black background (no scene, no props). Use the result as the motion source for Mannequin mode.',
