...
export const IMAGE_MODELS = [
    ...
    { id: 'nano-banana-2', name: 'Nano Banana 2', kind: 'nano_banana_2', gated: false, resolutions: ['1K', '2K'] },
...
export const MODES = [
    ...
    // production brief (locks on performance, audio, camera) the style needs.
    {
        id: 'motion_capture',
        name: 'Motion Capture',
        hint: 'Green-screen source video + reference image(s) — up to 3 videos (15s combined) and 9 images. Video 1 is the primary source of truth; extra videos are secondary reference. Your prompt is auto-structured by GPT-4o: performance, audio and camera stay locked; only what you ask for changes.',
        requiresText: true,
